...
readonly INSTALL_DIR="${WORK_LAB_HOME:-${XDG_DATA_HOME:-$HOME/.local/share}/work-lab}"
readonly CONFIG_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/work-lab"
readonly REPO_URL="https://github.com/modern-tooling/work-lab.git"
readonly GHCR_IMAGE="ghcr.io/modern-tooling/work-lab:latest"
